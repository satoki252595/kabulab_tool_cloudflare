/**
 * 008 overseas-sales 共通レイアウト — Editorial Swiss Grid。
 *
 * 共通デザイントークンは単一 source of truth である src/shared/design.ts から
 * 取り込み、サービス固有スタイルだけをここに連結する。template literal で返す
 * (JSX 禁止・mono-repo 方針)。
 */
...
<title>${h(title)} | kabulab 海外売上高検索</title>
<meta name="description" content="EDINET の有価証券報告書から海外（地域別）売上高と海外売上高比率を構造化し、最大5年の推移を可視化する定量情報検索ツール。">
<meta name="theme-color" content="#fafafa">
${FONT_LINKS}
<style>${DESIGN_TOKENS}\n${BASE_RESET}\n${SERVICE_STYLES}</style>
</head><body>
<header class="top-header"><div class="inner">
  <a href="${BASE_PATH}/" class="brand"><span class="mark"></span><span class="name"><span class="ja">海外売上検索</span><span class="en">008 / KABULAB</span></span></a>
...
<footer class="footer"><div class="inner">
  <div>© ${new Date().getFullYear()} kabulab — 海外売上高検索</div>
